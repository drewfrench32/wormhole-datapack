...
execute as @e[tag=is-wormhole,tag=wormhole-1] at @s if entity @e[type=player,distance=..0.8] run playsound minecraft:block.beacon.power_select master @a ^ ^ ^1 1.5 1.5
execute as @e[tag=is-wormhole,tag=wormhole-2] at @s if entity @e[type=player,distance=..0.8] run playsound minecraft:block.beacon.power_select master @a ^ ^ ^2 1.5 1.5
execute as @e[tag=is-wormhole,tag=wormhole-3] at @s if entity @e[type=player,distance=..0.8] run playsound minecraft:block.beacon.power_select master @a ^ ^ ^3 1.5 1.5
execute as @e[tag=is-wormhole,tag=wormhole-4] at @s if entity @e[type=player,distance=..0.8] run playsound minecraft:block.beacon.power_select master @a ^ ^ ^4 1.5 1.5
execute as @e[tag=is-wormhole,tag=wormhole-5] at @s if entity @e[type=player,distance=..0.8] run playsound minecraft:block.beacon.power_select master @a ^ ^ ^5 1.5 1.5
execute as @e[tag=is-wormhole,tag=wormhole-6] at @s if entity @e[type=player,distance=..0.8] run playsound minecraft:block.beacon.power_select master @a ^ ^ ^6 1.5 1.5
execute as @e[tag=is-wormhole,tag=wormhole-7] at @s if entity @e[type=player,distance=..0.8] run playsound minecraft:block.beacon.power_select master @a ^ ^ ^7 1.5 1.5
execute as @e[tag=is-wormhole,tag=wormhole-8] at @s if entity @e[type=player,distance=..0.8] run playsound minecraft:block.beacon.power_select master @a ^ ^ ^8 1.5 1.5
execute as @e[tag=is-wormhole,tag=wormhole-9] at @s if entity @e[type=player,distance=..0.8] run playsound minecraft:block.beacon.power_select master @a ^ ^ ^9 1.5 1.5
execute as @e[tag=is-wormhole,tag=wormhole-10] at @s if entity @e[type=player,distance=..0.8] run playsound minecraft:block.beacon.power_select master @a ^ ^ ^10 1.5 1.5
execute as @e[tag=is-wormhole,tag=wormhole-11] at @s if entity @e[type=player,distance=..0.8] run playsound minecraft:block.beacon.power_select master @a ^ ^ ^11 1.5 1.5
execute as @e[tag=is-wormhole,tag=wormhole-12] at @s if entity @e[type=player,distance=..0.8] run playsound minecraft:block.beacon.power_select master @a ^ ^ ^12 1.5 1.5
execute as @e[tag=is-wormhole,tag=wormhole-13] at @s if entity @e[type=player,distance=..0.8] run playsound minecraft:block.beacon.power_select master @a ^ ^ ^13 1.5 1.5
execute as @e[tag=is-wormhole,tag=wormhole-14] at @s if entity @e[type=player,distance=..0.8] run playsound minecraft:block.beacon.power_select master @a ^ ^ ^14 1.5 1.5
execute as @e[tag=is-wormhole,tag=wormhole-15] at @s if entity @e[type=player,distance=..0.8] run playsound minecraft:block.beacon.power_select master @a ^ ^ ^15 1.5 1.5
execute as @e[tag=is-wormhole,tag=wormhole-16] at @s if entity @e[type=player,distance=..0.8] run playsound minecraft:block.beacon.power_select master @a ^ ^ ^16 1.5 1.5
